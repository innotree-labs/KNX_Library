 ...
 *          one KNX_DPT tag plus a payload sized to the largest v1 datapoint. Typed
...
struct KnxValue {
	...
	bool isValid(void) const { return dpt != KNX_DPT::UNKNOWN; }
};

//---- Typed constructors: one per datapoint type, payload can only be its native type ----

inline KnxValue Dpt1(bool value)      { KnxValue v; v.dpt = KNX_DPT::DPT1;  v.payload.b   = value; return v; }
inline KnxValue Dpt2(uint8_t value)   { KnxValue v; v.dpt = KNX_DPT::DPT2;  v.payload.u8  = value & 0x03; return v; }
inline KnxValue Dpt3(bool increase, uint8_t stepcode) { KnxValue v; v.dpt = KNX_DPT::DPT3; v.payload.dim = DptDim{ increase, (uint8_t)(stepcode & 0x07) }; return v; }
inline KnxValue Dpt4(char value)      { KnxValue v; v.dpt = KNX_DPT::DPT4;  v.payload.ch  = value; return v; }
inline KnxValue Dpt5(uint8_t value)   { KnxValue v; v.dpt = KNX_DPT::DPT5;  v.payload.u8  = value; return v; }
inline KnxValue Dpt6(int8_t value)    { KnxValue v; v.dpt = KNX_DPT::DPT6;  v.payload.i8  = value; return v; }
inline KnxValue Dpt7(uint16_t value)  { KnxValue v; v.dpt = KNX_DPT::DPT7;  v.payload.u16 = value; return v; }
inline KnxValue Dpt8(int16_t value)   { KnxValue v; v.dpt = KNX_DPT::DPT8;  v.payload.i16 = value; return v; }
inline KnxValue Dpt9(float value)     { KnxValue v; v.dpt = KNX_DPT::DPT9;  v.payload.f   = value; return v; }
inline KnxValue Dpt10(DptTime value)  { KnxValue v; v.dpt = KNX_DPT::DPT10; v.payload.time = value; return v; }
inline KnxValue Dpt11(DptDate value)  { KnxValue v; v.dpt = KNX_DPT::DPT11; v.payload.date = value; return v; }
inline KnxValue Dpt12(uint32_t value) { KnxValue v; v.dpt = KNX_DPT::DPT12; v.payload.u32 = value; return v; }
inline KnxValue Dpt13(int32_t value)  { KnxValue v; v.dpt = KNX_DPT::DPT13; v.payload.i32 = value; return v; }
inline KnxValue Dpt14(float value)    { KnxValue v; v.dpt = KNX_DPT::DPT14; v.payload.f   = value; return v; }
inline KnxValue Dpt19(DptDateTime value) { KnxValue v; v.dpt = KNX_DPT::DPT19; v.payload.datetime = value; return v; }
inline KnxValue Dpt232(uint8_t r, uint8_t g, uint8_t b) { KnxValue v; v.dpt = KNX_DPT::DPT232; v.payload.color = DptColor{ r, g, b }; return v; }
